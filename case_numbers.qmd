...
case_count_plot_fun(case_count_year, "year", "cases", month_interactive = TRUE)
...
tmp <- case_count_function(all_cases_collapsed, grouping_vars = c("year", "herd_type_ml_description"))
ggplot(tmp %>% 
