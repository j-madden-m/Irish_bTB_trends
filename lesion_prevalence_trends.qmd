...
**NOTE: This section relies heavily on data from AIM on there is usually quite a lag on when this is received.**
...
To extract the proportion of animals with lesions at rountine slaughter we used the lab file and AIM database (below is just a snap shot of these files to help understand the process (need to update those))
